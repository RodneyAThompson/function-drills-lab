...
let nameGreeting = nameCheck("Rodney")
...
let yeehaw = theEliminator(contestants, loser)
console.log(yeehaw)
...
let emailThing = emailCheck('godneyson06@gmail.com')
...
//CODE HERE
function innappropriate(whateverItTakes) {
  let numFrogs = whateverItTakes / 3
  return numFrogs
}
totalFrogs = innappropriate(100)
console.log(totalFrogs)

////////////////// PROBLEM 14 ////////////////////
/*
  You might have noticed a slight bug in problem 12. 
  If you were to pass in 4 gold, the function would return to you 1.3333... However, 
  you can't really go to a store and by 1.333 products. You would just be able to purchase 1 product. 
...
//CODE HERE
function innappropriate2(whateverItTakes) {
  while(true) {
    if (whateverItTakes % 3 === 0) {
      let numFrogs = whateverItTakes/ 3
      return numFrogs
    } else {
      whateverItTakes -= 1
...
totalFrogs2 = innappropriate2(100)
